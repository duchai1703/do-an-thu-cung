...
export function ToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={{ showToast, removeToast }}>
      ...
      {/* Toast Container - Using Portal with highest z-index */}
          ...
          {toasts.map((toast) => {
            ...
            return (
              <div
                key={toast.id}
                className={cn(
                  "flex items-center gap-2 p-4 rounded-lg shadow-lg max-w-md animate-in slide-in-from-bottom-4 pointer-events-auto",
