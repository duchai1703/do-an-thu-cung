/**
 * Manager Profile Page - Premium UI 🎀
 * 
...
import { User, Shield, Lock, Key, Mail, Phone, Calendar, Save } from "lucide-react";
// import { useAuth } from "@/lib/contexts/AuthContext";

export default function ProfilePage() {
  const { showToast } = useToast();
  // const { user } = useAuth(); // AuthContext not available
  ...
  const loadProfile = async (accountId) => {
    try {
      setLoading(true);
      // Use the full-profile endpoint as requested
            ...
            <Card className="bg-blue-50 border-blue-100 border shadow-sm">
              <CardContent className="p-4 flex gap-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>Không chia sẻ mật khẩu của bạn với bất kỳ ai. Nhân viên hỗ trợ sẽ không bao giờ hỏi mật khẩu của bạn.</p>
                </div>
              </CardContent>
            </Card>
          </div>
