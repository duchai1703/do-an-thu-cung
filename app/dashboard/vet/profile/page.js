/**
 * Veterinarian Profile Page - Premium UI 🎀
 * 
 * Route: /dashboard/vet/profile
 * 
 * Features:
...
import { User, Shield, Lock, Key, Mail, Phone, Calendar, Save, Stethoscope } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 font-medium">Đang tải hồ sơ bác sĩ...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Header - Vet Theme (Teal/Blue) */}
        <div className="bg-gradient-to-r from-teal-500 to-blue-600 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-teal-50 border-teal-100 border shadow-sm">
