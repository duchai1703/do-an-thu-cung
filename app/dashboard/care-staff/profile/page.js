/**
 * Care Staff Profile Page - Premium UI 🎀
 * 
 * Route: /dashboard/care-staff/profile
 * 
 * Features:
...
import { User, Shield, Lock, Key, Mail, Phone, Calendar, Save, Briefcase } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 font-medium">Đang tải hồ sơ nhân viên...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        {/* Header - Staff Theme (Green/Emerald) */}
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-3xl p-8 text-white shadow-xl relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <Card className="bg-green-50 border-green-100 border shadow-sm">
